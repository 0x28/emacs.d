  ...
  #+BEGIN_SRC emacs-lisp :results silent
    (use-package eshell
      ...
      (add-hook 'eshell-directory-change-hook
                (lambda () (cl-pushnew (abbreviate-file-name default-directory)
                                  my/eshell-cd-history
                                  :test #'string=)))
...
** jump
  #+BEGIN_SRC emacs-lisp :results silent
    (defvar my/eshell-cd-history nil "Eshell directory history.")

    (defun eshell/j ()
      "Jump to a previously visited directory."
      (interactive)
      (eshell/cd (completing-read "jump: "
                                  my/eshell-cd-history)))
  #+END_SRC
